...
function ct_drop_post_class($classes)
{
...
add_filter('post_class', 'ct_drop_post_class');


//----------------------------------------------------------------------------------
// Add meta elements for the charset, viewport, and template
//----------------------------------------------------------------------------------
if (! function_exists(('ct_drop_add_meta_elements'))) {
    function ct_drop_add_meta_elements()
    {
        $meta_elements = '';
...
add_action('wp_head', 'ct_drop_add_meta_elements', 1);
